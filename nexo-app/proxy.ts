// proxy.ts — Next.js 16 Route Protection (reemplaza middleware.ts)
// Documentación: https://nextjs.org/docs/app/api-reference/file-conventions/proxy
...
const PROTECTED_PREFIXES = ['/dashboard', '/markets', '/trade', '/portfolio', '/wallet', '/admin']
